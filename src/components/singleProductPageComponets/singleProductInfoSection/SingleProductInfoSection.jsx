import "./SingleProductInfoSection.css";
import bigimg from "../../../img/singlpraductimg/bigimg.png";
import smolimg1 from "../../../img/singlpraductimg/smolimg1.png";
import smolimg2 from "../../../img/singlpraductimg/smolimg2.png";
import smolimg3 from "../../../img/singlpraductimg/smolimg3.png";
import smolimg4 from "../../../img/singlpraductimg/smolimg4.png";
function SingleProductInfoSection() {
    return (
        <div className="singleProductInfoSection_container">
            <div className="singleProductInfoSection_container_blok">
                <div className="singleProductInfoSection_container_blok_section1">
                    <div className="singleProductInfoSection_container_blok_section1_4img">
                        {/* 4 nkar */}
                        <div className="singleProductInfoSection_container_blok_section1_4img_blok">
                            <img
                                src={smolimg1}
                                alt="singlpraduct"
                                width={76}
                    ...
                    <div className="singleProductInfoSection_container_blok_section2">
                        {/* met nkar */}
                        <div className="singleProductInfoSection_container_blok_section2_blokimg">
                            <img src={bigimg} alt="" width={423} height={500} />
                        </div>
                    </div>
                </div>
                <div className="singleProductInfoSection_container_blok_section3">
                    {/* text */}
                    <p className="singleProductInfoSection_container_blok_section3_text1">
                        Asgaard sofa
                    </p>
                    <p className="singleProductInfoSection_container_blok_section3_text2">
                        Rs. 250,000.00
                    </p>
                    <div className="singleProductInfoSection_container_blok_section3_blokreyting">
                        {/* astxer */}
                        <div>
                            <svg
                                width="124"
                        ...
                        <div className="singleProductInfoSection_container_blok_section3_blokreyting_git"></div>
                        <p className="singleProductInfoSection_container_blok_section3_text3">
                            5 Customer Review
                        </p>
                    </div>
                    <p className="singleProductInfoSection_container_blok_section3_text4">
                    ...
                    <p className="singleProductInfoSection_container_blok_section3_text5">
                        Size
                    </p>
                    <div className="singleProductInfoSection_container_blok_section3_sizeBtnContener">
                        <div className="singleProductInfoSection_container_blok_section3_sizeBtnBlok singleProductInfoSection_container_blok_section3_sizeBtnBlokSelected">
                            L
                        </div>
                        <div className="singleProductInfoSection_container_blok_section3_sizeBtnBlok">
                            XL
                        </div>
                        <div className="singleProductInfoSection_container_blok_section3_sizeBtnBlok">
                            XS
                    ...
                    <p className="singleProductInfoSection_container_blok_section3_text6">
                        Color
                    </p>
                    <div className="singleProductInfoSection_container_blok_section3_colorBtnContener">
                        <div
                            className="singleProductInfoSection_container_blok_section3_colorBtnContener_blok
                            singleProductInfoSection_container_blok_section3_colorBtnContener_blok_color1"
                        ></div>
                        <div
                            className="singleProductInfoSection_container_blok_section3_colorBtnContener_blok
                            singleProductInfoSection_container_blok_section3_colorBtnContener_blok_color2"
                        ></div>
                        <div
                            className="singleProductInfoSection_container_blok_section3_colorBtnContener_blok
                            singleProductInfoSection_container_blok_section3_colorBtnContener_blok_color3"
                        ></div>
                    </div>
                    {/* knopkeq */}
                    <div className="singleProductInfoSection_container_blok_section3_BtnContener">
                        <div className="singleProductInfoSection_container_blok_section3_BtnContener_count">
                            <p>-</p>
                            <p>1</p>
                            <p>+</p>
                        </div>
                    ...
                    <div className="singleProductInfoSection_container_blok_section3_footerContener">
                        <div className="singleProductInfoSection_container_blok_section3_footerContener_blok">
                            <p className="singleProductInfoSection_container_blok_section3_footerContener_blok_text">
                                SKU
                            </p>
                            <p>:SS001</p>
                        </div>
                        ...
                        <div className="singleProductInfoSection_container_blok_section3_footerContener_blok">
                            ...
                            <div className="singleProductInfoSection_container_blok_section3_footerContener_blok_icon">
                                :
                                <svg
                                    width="20"
                                    height="20"
