import "./BlogMainListItems.css";
import postimg1 from "../../../../../img/blogimg/blogimg1.jpg";
import postimg2 from "../../../../../img/blogimg/blogimg2.jpg";
import postimg3 from "../../../../../img/blogimg/blogimg3.jpg";
function BlogMainListItems() {
    return (
        <div className="blogMainListItems_container">
            <div
                className="blogMainListItems_container_blokImg"
                style={{
            ...
            ></div>
            <div className="blogMainListItems_container_blokIconText">
                <div className="blogMainListItems_container_blokIconText_items">
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                    ...
                    <p className="blogMainListItems_container_blokIconText_items_Text">
                        Admin
                    </p>
                </div>
                <div className="blogMainListItems_container_blokIconText_items">
            ...
            <p className="blogMainListItems_container_tittel">
                Going all-in with millennial design
            </p>
            <p className="blogMainListItems_container_text">
            ...
            <div className="blogMainListItems_container_btnReadMore">
                <p>Read more</p>
                <div></div>
            </div>
            <div
...
export default BlogMainListItems;
