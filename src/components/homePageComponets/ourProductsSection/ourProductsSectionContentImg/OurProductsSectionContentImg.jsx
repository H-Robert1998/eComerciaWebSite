...
import img1 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg1.png"
import img2 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg2.png"
import img3 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg3.png"
import img4 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg4.png"
import img5 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg5.png"
import img6 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg6.png"
import img7 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg7.png"
import img8 from "../../../../img/homePageimg/ourProductsSectionimg/ourProductsSectionimg8.png"
        ...
        <div className="ourProductsSectionContentImg_container">
            <div className="ourProductsSectionContentImg_container_blok">
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img1} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                    </div>
                        ...
                        <div className="container_blok_itemstext_clikAddCard_IconTextblok">
                            ...
                            <div>
                                <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.81858 12.8009C-5.51448 5.43146 3.81884 -2.56854 7.81858 2.49016C11.8188 -2.56854 21.1522 5.43146 7.81858 12.8009Z" stroke="white" stroke-width="1.8"/>
                                </svg>
                                <p>Like</p>
                            </div>
                        </div>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img2} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img3} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img4} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img5} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img6} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img7} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
                ...
                <div className="ourProductsSectionContentImg_container_blok_itemstext">
                    <img src={img8} alt="Product" width={285} height={301}/>
                    <div className="ourProductsSectionContentImg_container_blok_itemstext_textblok">
                        <p className="textblok_tect1">Syltherine</p>
                        <p className="textblok_tect2">Stylish cafe chair</p>
                        <p className="textblok_tect3">Rp 2.500.000<p className="textblok_tect3_1">Rp 3.500.000</p></p>
